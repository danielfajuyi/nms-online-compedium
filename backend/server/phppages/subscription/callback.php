...
$mail->setFrom('nmsonlinecompedium@gmail.com','compedium Subcription');
														...
														<tr>
															<td class="pad" style="padding-left:25px;padding-top:5px;width:100%;padding-right:0px;">
																<div class="alignment" align="left" style="line-height:10px">
																	<div style="max-width: 150.75px;"><img src="https://d15k2d11r6t6rl.cloudfront.net/public/users/Integrators/BeeProAgency/1108030_1093499/nms-logo.png" style="display: block; height: auto; border: 0; width: 100%;" width="150.75" alt="Alternate text" title="Alternate text"></div>
																</div>
															</td>
														</tr>
													</table>
